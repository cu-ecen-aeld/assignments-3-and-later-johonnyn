...
cp $(find /usr/local/arm-cross-compiler/ -name ld-linux-aarch64.so.1 -print -quit) ${OUTDIR}/rootfs/lib/
cp $(find /usr/local/arm-cross-compiler/ -name libm.so.6 -print -quit) ${OUTDIR}/rootfs/lib64/
cp $(find /usr/local/arm-cross-compiler/ -name libresolv.so.2 -print -quit) ${OUTDIR}/rootfs/lib64/
cp $(find /usr/local/arm-cross-compiler/ -name libc.so.6 -print -quit) ${OUTDIR}/rootfs/lib64/
